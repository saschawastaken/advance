...
def menu():
    ...
    titleText = "Advancer"
    title = getText(titleText, 30, 'gillsansultracondensed', (255,255,255), True)
    ...
    ui.add_button("Start", bStart, (200,200,200), (0,200,0), (0,0,0), (255,255,255))
    ui.add_button("Quit", bQuit, (200,200,200), (200,0,0), (0,0,0), (255,255,255))
